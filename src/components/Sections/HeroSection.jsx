...
`}
              ...
              >
                ...
                <motion.button
                  ...
                  }  px-8 py-3 text-sm uppercase tracking-wider font-medium transition-all duration-300`}
                >
                  Get in Touch
                </motion.button>
              </motion.div>
              ...
              <motion.div
                variants={itemVariants}
                className="
              flex justify-center items-center space-x-6 text-xs uppercase tracking-widest flex-wrap 
              "
              >
                <span
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              text-5xl xl:text-7xl font-light mb-8 leading-tight
              "
              >
                <span
                  className={`${isDarkMode ? "text-white" : "text-gray-900"}`}
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  variants={itemVariants}
                  className="
                flex items-center space-x-8 text-xs uppercase tracking-widest absolute -top-16 -left-28
                "
                >
                  <span
                    className={isDarkMode ? "text-gray-600" : "text-gray-500"}
                ...
                <motion.div
                  ...
                  className="absolute -inset-8 rpunded-3xl border border-purple-500/10"
                />
              </div>
            </motion.div>
          </div>
